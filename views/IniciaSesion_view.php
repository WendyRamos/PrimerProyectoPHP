...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/grid/IniciaSesion.css">
...
<body>
	<div class="contenedor"> 
		...
		<article>
			<img class="jovenesyleon" src="img/jovenesyleon.png">
			<img class="leon" src="img/leon.png">
			<img class="leones" src="img/leones.png">
			<img class="usuario" src="img/usuario.png">
			<img class="llave" src="img/llave.png">
			...
			<p>¿No tienes cuenta?<a href="registrate.php" class="btn-registrate">Registrate</a></p>
		</article>
		<footer>
